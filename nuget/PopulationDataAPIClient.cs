...
namespace APIVerve.API.PopulationData
{
    ...
    /// <summary>
    /// Client for the PopulationData API
    /// </summary>
    public class PopulationDataAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/population";
        ...
        public PopulationDataAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PopulationDataAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PopulationDataAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PopulationDataQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PopulationDataQueryOptions options)
        {
        ...
        public ResponseObj Execute(PopulationDataQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PopulationDataQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PopulationDataQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PopulationDataQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PopulationDataQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PopulationDataQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PopulationDataQueryOptions options)
        {
