// Package population provides a Go client for the Population Data API.
//
// For more information, visit: https://apiverve.com/marketplace/population?utm_source=go&utm_medium=readme
package population
...
// Request contains the parameters for the Population Data API.
//
// Parameters:
...
// ResponseData contains the data returned by the Population Data API.
type ResponseData struct {
	...
	PopulationFormatted string `json:"populationFormatted"`
	GrowthRate float64 `json:"growthRate"`
	Density float64 `json:"density"`
	DensityUnit string `json:"densityUnit"`
	UrbanPercent float64 `json:"urbanPercent"`
	RuralPercent float64 `json:"ruralPercent"`
	UrbanPopulation int `json:"urbanPopulation"`
	RuralPopulation int `json:"ruralPopulation"`
