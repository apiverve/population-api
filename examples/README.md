# Population Data API - Examples

This folder contains example code for using the Population Data API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/population',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/population](https://docs.apiverve.com/ref/population)
