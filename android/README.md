...
```gradle
dependencies {
    implementation 'com.github.apiverve:population-api:1.1.13'
}
```
...
```java
import com.apiverve.population.PopulationDataAPIClient;
import com.apiverve.population.APIResponse;
import com.apiverve.population.APIException;

// Initialize the client
PopulationDataAPIClient client = new PopulationDataAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/population](https://docs.apiverve.com/ref/population)
...
- **Documentation:** [https://docs.apiverve.com/ref/population](https://docs.apiverve.com/ref/population)
- **Issues:** [GitHub Issues](https://github.com/apiverve/population-api/issues)
